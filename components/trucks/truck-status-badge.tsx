...
export function TruckStatusBadge({ status }: { status: TruckAvailability }) {
  const styles = { available: "border-emerald-700/15 bg-white/95 text-emerald-800", in_transit: "border-warning bg-warning text-[#111111]", occupied: "border-black/10 bg-[#111111]/85 text-white", maintenance: "border-danger/20 bg-white/95 text-danger" };
