...
const messages = {
  pt: {
    "nav.home": "Início", "nav.trucks": "Encontrar camião", "nav.publish": "Publicar camião", "nav.how": "Como funciona", "nav.about": "Sobre nós", "nav.companies": "Empresas",
    "auth.signin": "Entrar", "auth.register": "Cadastrar camião",
  ...
  fr: {
    "nav.home": "Accueil", "nav.trucks": "Trouver un camion", "nav.publish": "Publier un camion", "nav.how": "Comment ça marche", "nav.about": "À propos", "nav.companies": "Entreprises",
    "auth.signin": "Se connecter", "auth.register": "Inscrire mon camion",
  ...
  en: {
    "nav.home": "Home", "nav.trucks": "Find a truck", "nav.publish": "List a truck", "nav.how": "How it works", "nav.about": "About", "nav.companies": "Companies",
    "auth.signin": "Sign in", "auth.register": "Register my truck",
