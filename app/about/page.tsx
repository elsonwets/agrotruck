  ...
  return <>
    <section className="overflow-hidden bg-primary py-16 text-white md:py-24">
      <div className="page-shell grid items-end gap-10 lg:grid-cols-[1.1fr_.9fr]">
        ...
        <p className="max-w-xl border-l border-white/20 pl-6 font-light leading-7 text-white/72">A AgroTruck não é uma transportadora e não faz reservas. Criamos um ponto de encontro simples entre quem precisa de transporte e quem possui capacidade disponível.</p>
      </div>
    </section>
    ...
    <section className="border-y border-primary/10 bg-[#f8f8f5] py-16"><div className="page-shell flex flex-col justify-between gap-8 md:flex-row md:items-center"><div className="max-w-2xl"><div className="flex items-center gap-2 text-primary"><ShieldCheck className="size-5"/><span className="text-xs font-bold uppercase tracking-[.16em]">Simples por decisão</span></div><h2 className="mt-3 font-heading text-3xl font-bold tracking-[-.035em]">Sem pagamento. Sem reserva. Sem intermediário.</h2></div><Button asChild size="lg"><Link href="/"><Truck className="size-4"/> Ver trucks disponíveis <ArrowRight className="size-4"/></Link></Button></div></section>
  </>;
}
