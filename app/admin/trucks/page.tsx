...
export default async function AdminTrucksPage() {
  ...
  return <main className="min-h-[70vh] bg-[#f8f8f5] pb-24 pt-10"><div className="page-shell"><p className="text-xs font-bold uppercase tracking-[.2em] text-danger">Administração</p><div className="mt-3 flex flex-wrap items-end justify-between gap-4"><div><h1 className="font-heading text-4xl font-extrabold tracking-[-.04em] md:text-5xl">Pagamentos e validações</h1><p className="mt-3 text-sm font-light text-muted-foreground">Confirme o pagamento e os dados. O proprietário decidirá depois quando colocar o truck online.</p></div><span className="rounded-full bg-warning/20 px-4 py-2 text-sm font-bold text-[#705d00]">{pending.length} em espera</span></div>
